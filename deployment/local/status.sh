...
check_service() {
    ...
    if [ "$name" = "Keycloak IAM" ]; then
        if command -v docker &> /dev/null && docker ps | grep -q "***REMOVED-KEYCLOAK_DB_PASSWORD***-cms"; then
...
echo "=========================="
check_docker_container "Main App Database" "***REMOVED-DB_PASSWORD***-app" "***REMOVED-DB_PASSWORD***ql://localhost:5432/contract_management" "5432" "Main application database"
check_docker_container "Keycloak Database" "***REMOVED-DB_PASSWORD***-***REMOVED-KEYCLOAK_DB_PASSWORD***" "***REMOVED-DB_PASSWORD***ql://localhost:5433/***REMOVED-KEYCLOAK_DB_PASSWORD***" "5433" "Keycloak IAM database"
check_docker_container "SCITT CCF Database" "scitt-ccf-***REMOVED-DB_PASSWORD***-dev" "***REMOVED-DB_PASSWORD***ql://localhost:5434/scitt_ccf_dev" "5434" "SCITT CCF ledger database"
...
echo "  Main App DB: ***REMOVED-DB_PASSWORD***ql://***REMOVED-DB_PASSWORD***:***REMOVED-DB_PASSWORD***@localhost:5432/contract_management"
echo "  Keycloak DB: ***REMOVED-DB_PASSWORD***ql://***REMOVED-KEYCLOAK_DB_PASSWORD***:***REMOVED-KEYCLOAK_DB_PASSWORD***@localhost:5433/***REMOVED-KEYCLOAK_DB_PASSWORD***"
echo "  SCITT CCF DB: ***REMOVED-DB_PASSWORD***ql://scitt_user:scitt_pass@localhost:5434/scitt_ccf_dev"
