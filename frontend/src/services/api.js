...
const realApiService = {
  ...
  firstLoginPassword: (passwordData) => api.post('/api/auth/first-login-password', passwordData),
...
const mockApiService = {
  ...
  updatePassword: () => { throw new Error('Mock API: updatePassword() not implemented for registration testing'); },
  firstLoginPassword: () => { throw new Error('Mock API: firstLoginPassword() not implemented for registration testing'); },
  refreshToken: () => { throw new Error('Mock API: refreshToken() not implemented for registration testing'); },
  verifyDID: () => { throw new Error('Mock API: verifyDID() not implemented for registration testing'); },
  forgotPassword: () => { throw new Error('Mock API: forgotPassword() not implemented for registration testing'); },
  resetPassword: () => { throw new Error('Mock API: resetPassword() not implemented for registration testing'); },
  verifyResetToken: () => { throw new Error('Mock API: verifyResetToken() not implemented for registration testing'); },
  getDevResetToken: () => { throw new Error('Mock API: getDevResetToken() not implemented for registration testing'); },
  updateProfile: () => { throw new Error('Mock API: updateProfile() not implemented for registration testing'); },
