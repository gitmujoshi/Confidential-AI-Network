  ...
  try {
    ...
    try {
      ...
      try {
        ...
        ***REMOVED-KEYCLOAK_DB_PASSWORD***Success = true;
        ...
        return res.status(500).json({
          ...
          message: ***REMOVED-KEYCLOAK_DB_PASSWORD***Error.message
        });
      }
      ...
      try {
        ...
        await transaction.rollback();
        if (***REMOVED-KEYCLOAK_DB_PASSWORD***Result && ***REMOVED-KEYCLOAK_DB_PASSWORD***Result.***REMOVED-KEYCLOAK_DB_PASSWORD***UserId) {
          try {
            await ***REMOVED-KEYCLOAK_DB_PASSWORD***Service.deleteUser(***REMOVED-KEYCLOAK_DB_PASSWORD***Result.***REMOVED-KEYCLOAK_DB_PASSWORD***UserId);
