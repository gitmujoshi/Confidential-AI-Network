...
describe('SCITT CCF Integration Tests', () => {
  ...
  beforeAll(async () => {
    ...
    scittService = new MockRegistry.serviceConstructors.ScittCcfService();
    contractRouter = new MockRegistry.serviceConstructors.ContractRouterService();
    healthMonitor = new MockRegistry.serviceConstructors.SystemHealthMonitor();
  });
