...
function writeConfig(configObj) {
  try {
    ...
    lines.push(`JWT_SECRET=${configObj.JWT_SECRET || '9e1dc05d85ea88635b0a85b4ea641f984d33c1d95deb06255586ed3841368d23'}`);
    lines.push('');
    ...
    lines.push(`SESSION_SECRET=${configObj.SESSION_SECRET || '9e1dc05d85ea88635b0a85b4ea641f984d33c1d95deb06255586ed3841368d23'}`);
    lines.push('');
