...
docker-compose -f docker-compose.main.yml down --remove-orphans 2>/dev/null || true
docker-compose -f docker-compose.scitt-ccf-dev.yml down --remove-orphans 2>/dev/null || true
