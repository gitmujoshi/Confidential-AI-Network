...
3. **Database connection issues**
   ...
   - Check logs: `docker-compose -f docker-compose.dev.yml logs ***REMOVED-DB_PASSWORD***-app`

4. **Keycloak issues**
   - Wait for Keycloak to be ready
   - Check logs: `docker-compose -f docker-compose.dev.yml logs ***REMOVED-KEYCLOAK_DB_PASSWORD***`
