...
> Screenshots refreshed: **2026-08-19** (party signing key at registration; auditor steps via `test:e2e:auditor-guide`). Prefer regenerating over hand-editing images.
