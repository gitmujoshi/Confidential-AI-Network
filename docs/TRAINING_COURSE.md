...
docker-compose -f deployment/utilities/docker-compose.iam.yml restart keycloak
...
| Keycloak realm import / automation            | `deployment/utilities/keycloak-config/`, `backend/scripts/setupKeycloak.js`             |
