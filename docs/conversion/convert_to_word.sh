...
# Convert IAM Specifications to Word Document
# This script converts the markdown IAM specifications to a Word document

echo "Converting IAM Specifications to Word document..."
...
pandoc IAM_SPECIFICATIONS_DOCUMENT.md \
    -o ../output/IAM_Specifications.docx \
    --from markdown \
    --to docx \
...
if [ $? -eq 0 ]; then
    echo "✅ Successfully converted to Word document: docs/output/IAM_Specifications.docx"
...
echo "  open ../output/IAM_Specifications.docx" 