...
(from registration through training, provenance, and inference — Local Docker and OCI paths).
...
| **NIST / CIS control mapping** | [SECURITY_CONTROLS_NIST_CIS_MAPPING.md](https://github.com/gitmujoshi/Confidential-AI-Network/blob/main/docs/compliance/SECURITY_CONTROLS_NIST_CIS_MAPPING.md) |
...
| OCI product tour | Product tour [§ OCI path](https://gitmujoshi.github.io/Confidential-AI-Network/product-tour/#oci) · local `/demo/oci-scaffolds` · [OciScaffoldDemo.js](https://github.com/gitmujoshi/Confidential-AI-Network/blob/main/frontend/src/pages/OciScaffoldDemo.js) |
