...
function loadConfig(options = {}) {
  ...
  const defaults = {
    ...
    KEYCLOAK_DB_PASSWORD: '***REMOVED-KEYCLOAK_DB_PASSWORD***',
...
function getTestConfig() {
  ...
  return {
    ...
    ***REMOVED-KEYCLOAK_DB_PASSWORD***: process.env.KEYCLOAK_URL || 'https://localhost:8443',
    database: {
      host: process.env.DB_HOST || 'localhost',
      port: parseInt(process.env.DB_PORT) || 5432,
      name: process.env.DB_NAME || 'contract_management',
      user: process.env.DB_USER || '***REMOVED-DB_PASSWORD***',
