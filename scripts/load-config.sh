...
load_config() {
    ...
    DB_PASSWORD=${DB_PASSWORD:-"***REMOVED-DB_PASSWORD***"}
    POSTGRES_PASSWORD=${POSTGRES_PASSWORD:-"***REMOVED-DB_PASSWORD***"}
    KEYCLOAK_DB_PASSWORD=${KEYCLOAK_DB_PASSWORD:-"***REMOVED-KEYCLOAK_DB_PASSWORD***"}
    JWT_SECRET=${JWT_SECRET:-"***REMOVED-JWT_SECRET***"}
    KEYCLOAK_CLIENT_SECRET=${KEYCLOAK_CLIENT_SECRET:-"***REMOVED-KEYCLOAK_CLIENT_SECRET***"}
    KEYCLOAK_ADMIN_PASSWORD=${KEYCLOAK_ADMIN_PASSWORD:-"***REMOVED-KEYCLOAK_ADMIN_PASSWORD***"}
    EMAIL_PASS=${EMAIL_PASS:-"***REMOVED-EMAIL_PASS***"}
    VAULT_TOKEN=${VAULT_TOKEN:-"***REMOVED-VAULT_TOKEN***"}
